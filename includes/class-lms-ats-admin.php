<?php
/**
 * Interface d'administration : page de réglages, mapping (lecture), journal, sync manuelle.
 */
...
class LMS_ATS_Admin {
	...
	/**
	 * Déclenchement d'une synchro manuelle.
	 */
	public function handle_sync_now() {
		...
		wp_safe_redirect( add_query_arg( array( 'page' => self::MENU_SLUG, $flag => 1 ), admin_url( 'admin.php' ) ) );
		exit;
	}
	...
	public function render_page() {
		...
		<div class="wrap">
			...
			<?php if ( isset( $_GET['synced'] ) ) : ?>
				<div class="notice notice-success is-dismissible"><p>Synchronisation terminée. Voir le journal ci-dessous.</p></div>
			<?php endif; ?>
				...
				<table class="form-table" role="presentation">
					...
					<tr>
						...
						<td>
							...
							<p class="description">Aucune suppression n'est jamais effectuée.</p>
						</td>
					</tr>
					<tr>
			...
			<form method="post" action="<?php echo esc_url( $post_url ); ?>">
				...
				<p>
					...
					<span class="description">Recommandé : cocher « Mode simulation » pour un premier essai.</span>
				</p>
			</form>
